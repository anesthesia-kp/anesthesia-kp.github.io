...
# ⏳ FILED, NOT YET PUSHED: auction admin **312 · 313** (§153 — his four Phase-4 round defects)
**The LIVE line below says admin 311 and that is still true — it does NOT cover 312–313.** Both are
on disk and gated: new suite 16/16, honesty 12 of 16 red on the pushed 311, battery 63 suites /
2,221 assertions, isolation 36/36, both sweeps clean. `versions.json` on disk reads 313 while the
served site reads 311 — expected until he pushes.
