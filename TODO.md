...
**STATUS — generated 2026-08-17 04:56 UTC by `node status.mjs`. Regenerate after every push.**

| | build (disk) | versions.json | live check |
|---|---|---|---|
| Auction admin / staff / mobile | 269 / 139 / — | 269 / 139 / 17 | live: unreachable (offline?) |
| Schedule admin / staff | 64 / 29 | 64 / 29 | live: unreachable (offline?) |
...
Suites on disk: auction **14** (`tests/test-*.mjs`) · schedule **18**
