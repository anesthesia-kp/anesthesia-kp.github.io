...
**STATUS — generated 2026-08-24 02:31 UTC by `node status.mjs`. Regenerate after every push.**

| | build (disk) | versions.json | live check |
|---|---|---|---|
| Auction admin / staff / mobile | 301 / 163 / — | 301 / 163 / 18 | live: unreachable (offline?) |
...
Suites on disk: auction **52** (`tests/test-*.mjs`) · schedule **27**
...
## ✅ QUEUE EMPTY — §87 IS COMPLETE. ADMIN 300 IS PUSHED AND LIVE (22 Aug 2026).
...
## ✅ SORT-1 — BUILT AS ADMIN 301, 24 Aug 2026 (DECISIONS §88). Filed, not pushed.
...
## Owner request, 22 Aug 2026 — recapture the deck's screenshots and cover the newer features (DECK-2)

- [ ] **DECK-2 · The walkthrough deck's images are a build behind, and newer user-facing features
      are not in it.** Owner: *"Keep as a todo to update images and include all newer features. I
