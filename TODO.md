...
**STATUS — generated 2026-08-19 17:54 UTC by `node status.mjs`. Regenerate after every push.**

| | build (disk) | versions.json | live check |
|---|---|---|---|
| Auction admin / staff / mobile | 283 / 148 / — | 283 / 148 / 18 | live: unreachable (offline?) |
| Schedule admin / staff | 73 / 33 | 73 / 33 | live: unreachable (offline?) |
...
### FB-6 · ⬆ NEXT BUILD — the security box is invisible to returning users (now also a compliance gap)
