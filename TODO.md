...
**STATUS — generated 2026-08-20 02:09 UTC by `node status.mjs`. Regenerate after every push.**

| | build (disk) | versions.json | live check |
|---|---|---|---|
| Auction admin / staff / mobile | 284 / 152 / — | 284 / 152 / 18 | live: unreachable (offline?) |
| Schedule admin / staff | 74 / 35 | 74 / 35 | live: unreachable (offline?) |
...
Suites on disk: auction **23** (`tests/test-*.mjs`) · schedule **25**
...
## 🔴 QUEUE HEAD — A-AUDIT · FULL PRE-LAUNCH ADVERSARIAL AUDIT — **GO, after FB-5 batch 2**
...
- [ ] **W-1 · Lowerings visibility for USERS (staff page).** Owner: users need a way to track
...
- [ ] **W-2 · Grammar fix (admin page):** the Phase-1 unlock warning renders "unlock 1
