...
**STATUS — generated 2026-08-18 14:49 UTC by `node status.mjs`. Regenerate after every push.**

| | build (disk) | versions.json | live check |
|---|---|---|---|
| Auction admin / staff / mobile | 269 / 139 / — | 269 / 139 / 17 | live: unreachable (offline?) |
| Schedule admin / staff | 65 / 29 | 65 / 29 | live: unreachable (offline?) |
...
Suites on disk: auction **15** (`tests/test-*.mjs`) · schedule **19**
...
2. **S2 Render rework** — dirty-flag rendering. GO — **IN BUILD NOW.**
3. **S3 Quick-wins visual batch** — sticky headers/columns everywhere · today + holiday markers · eligibility defaults to one family · stats family-collapse + totals · reports reorder + grouped chips · catalog column headers. GO.
