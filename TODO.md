...
**STATUS — generated 2026-08-22 06:07 UTC by `node status.mjs`. Regenerate after every push.**
...
## 🔴 QUEUE HEAD — §86 IS RULED. STAFF 162 SHIPPED TWO. TWO BUILDS REMAIN, NEITHER STARTED.
...
>    owner's own find promoted from latent to LIVE. **RA-2 must be run before and after**; as of
>    22 Aug it is **59/59 on the current rules with 7 of 7 gates failing on the pre-RA-3 fixture**,
>    and for most of that day `firestore.rules` had no executable coverage at all.
