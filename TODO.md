...
**STATUS — generated 2026-08-20 14:30 UTC by `node status.mjs`. Regenerate after every push.**

| | build (disk) | versions.json | live check |
|---|---|---|---|
| Auction admin / staff / mobile | 291 / 156 / — | 291 / 156 / 18 | live: unreachable (offline?) |
...
Suites on disk: auction **35** (`tests/test-*.mjs`) · schedule **26**
