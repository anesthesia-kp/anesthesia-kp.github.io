...
**STATUS — generated 2026-08-18 22:27 UTC by `node status.mjs`. Regenerate after every push.**

| | build (disk) | versions.json | live check |
|---|---|---|---|
| Auction admin / staff / mobile | 275 / 142 / — | 275 / 142 / 18 | live: unreachable (offline?) |
...
Suites on disk: auction **19** (`tests/test-*.mjs`) · schedule **23**
