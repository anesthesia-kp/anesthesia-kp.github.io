...
**STATUS — generated 2026-08-22 06:01 UTC by `node status.mjs`. Regenerate after every push.**
...
>    owner's own find promoted from latent to LIVE. **RA-2 must be run before and after**; it is
>    green at 59/59 today, and until 22 Aug `firestore.rules` had no executable coverage at all.
