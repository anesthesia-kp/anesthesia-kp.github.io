...
**STATUS — generated 2026-08-19 04:42 UTC by `node status.mjs`. Regenerate after every push.**
...
## 🔴 QUEUE HEAD — A-AUDIT · FULL PRE-LAUNCH ADVERSARIAL AUDIT (owner order, 18 Aug 2026)

**THE VACATION BUILD QUEUE IS CLOSED. The next session does not build — it AUDITS.**
...
**One phrase deliberately NOT changed — needs a ruling.** The rules list and the welcome
e-mail both carry *"A combined bid like 1/2/3 uses bids 1, 2, and 3 at once"*. That defines
what a combined bid IS rather than listing which bids are allowed, so it reads as a different
kind of sentence and was left alone. If the owner wants that gone too, it is a one-line change
on both sites.
