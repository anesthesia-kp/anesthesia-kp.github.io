...
**STATUS — generated 2026-08-20 04:56 UTC by `node status.mjs`. Regenerate after every push.**

| | build (disk) | versions.json | live check |
|---|---|---|---|
| Auction admin / staff / mobile | 285 / 154 / — | 285 / 154 / 18 | live: unreachable (offline?) |
...
Suites on disk: auction **26** (`tests/test-*.mjs`) · schedule **25**
