...
**STATUS — generated 2026-08-21 01:52 UTC by `node status.mjs`. Regenerate after every push.**

| | build (disk) | versions.json | live check |
|---|---|---|---|
| Auction admin / staff / mobile | 296 / 158 / — | 296 / 158 / 18 | live: unreachable (offline?) |
...
Suites on disk: auction **42** (`tests/test-*.mjs`) · schedule **27**
