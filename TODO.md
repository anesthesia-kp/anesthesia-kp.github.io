...
**STATUS — generated 2026-08-20 00:29 UTC by `node status.mjs`. Regenerate after every push.**
...
- [ ] **A-AUDIT · THE AUDIT.** No feature work until it is done and the owner has ruled on
      ...
      **Two additional passes, owner ruling 19 Aug (DECISIONS §67), beyond code review:**
      - **MEGAFUZZ** — fuzz the input surfaces: bid amounts and week keys, names/e-mails at
        ...
        CRITICAL/HIGH bar.
      - **CHROME WALKTHROUGH — every single button.** Drive the live pages by Chrome control
        and click every button on all six pages to prove proper functionality. Destructive or
