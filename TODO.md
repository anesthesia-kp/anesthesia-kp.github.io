...
**STATUS — generated 2026-08-20 06:07 UTC by `node status.mjs`. Regenerate after every push.**

| | build (disk) | versions.json | live check |
|---|---|---|---|
| Auction admin / staff / mobile | 290 / 156 / — | 290 / 156 / 18 | live: unreachable (offline?) |
| Schedule admin / staff | 75 / 35 | 75 / 35 | live: unreachable (offline?) |

| repo | working tree | vs origin | git locks |
|---|---|---|---|
| vacation-kp.github.io | 16 uncommitted file(s) | in sync with origin | no locks |
...
Suites on disk: auction **34** (`tests/test-*.mjs`) · schedule **26**
...
- [ ] **RA-1 · RE-AUDIT everything changed on 20 Aug 2026** (owner: "i will want a re-audit
