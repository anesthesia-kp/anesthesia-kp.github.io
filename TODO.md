...
**STATUS — generated 2026-08-18 19:13 UTC by `node status.mjs`. Regenerate after every push.**

| | build (disk) | versions.json | live check |
|---|---|---|---|
| Auction admin / staff / mobile | 270 / 140 / — | 270 / 140 / 17 | live: unreachable (offline?) |
...
Suites on disk: auction **16** (`tests/test-*.mjs`) · schedule **23**
