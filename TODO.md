...
**STATUS — generated 2026-08-22 06:26 UTC by `node status.mjs`. Regenerate after every push.**

| | build (disk) | versions.json | live check |
|---|---|---|---|
| Auction admin / staff / mobile | 299 / 162 / — | 299 / 162 / 18 | live: unreachable (offline?) |
...
Suites on disk: auction **49** (`tests/test-*.mjs`) · schedule **27**
