...
**STATUS — generated 2026-08-19 17:45 UTC by `node status.mjs`. Regenerate after every push.**

| | build (disk) | versions.json | live check |
|---|---|---|---|
| Auction admin / staff / mobile | 282 / 147 / — | 282 / 147 / 18 | live: unreachable (offline?) |
| Schedule admin / staff | 72 / 32 | 72 / 32 | live: unreachable (offline?) |
...
| anesthesia-kp.github.io | 2 uncommitted file(s) | AHEAD of origin — push pending | no locks |
