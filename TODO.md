...
**STATUS — generated 2026-08-19 15:19 UTC by `node status.mjs`. Regenerate after every push.**
...
5. **S5 Grid upgrades** — IN PROGRESS 19 Aug 2026. coverage strip + filters + density toggle
   ...
   **Awaiting owner push.**) · ~~**S5b** flipped shifts-as-rows view~~ **— DONE, build 70**
   ...
   `gridView` added, caught by the battery. **Awaiting owner push.**) · **S5c** filter bar, name + coverage only, with role/site
   grouping deferred to ride with Stage 4.
